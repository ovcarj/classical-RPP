...
#        dyn = NPT(self._atoms, timestep=self._timestep * units.fs, temperature=self._temperature, externalstress=1e-5, ttime=1000*units.fs, pfactor=0.05)
        dyn = NPTber(self._atoms, timestep=self._timestep * units.fs, temperature=self._temperature, fixcm=True, pressure=1.01325, taut=1e3 * units.fs, taup=1e3 * units.fs, compressibility=0.001)
