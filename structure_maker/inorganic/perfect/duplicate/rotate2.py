...
MA_atoms_up.positions[:,2] += 22.
MA_atoms_up.euler_rotate(phi=90., center='COM')

inorganic_up = inorganic.copy()
inorganic_up.positions[:,2] += 22.
inorganic_up.euler_rotate(phi=90., center='COM')
