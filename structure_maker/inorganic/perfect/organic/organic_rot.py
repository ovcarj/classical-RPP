...
final1 = frame[10].position + delta0_rot
...
final7 = frame[0].position + delta0
final7[2] += 30.
...
final3 = frame[0].position - delta0
...
final5 = frame[10].position - delta0_rot
...
atoms.write('1n1_rot_final.traj')
