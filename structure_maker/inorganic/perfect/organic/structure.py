...
delta_z_factor = 2.0 #inorganic layers distance is equal to delta_z_factor * molecule length
cell_x_factor = 0.0
cell_z_factor = 0.0
cell_y_factor = 0.0
...
frame = read('/home/essil/Documents/structure_maker/inorganic/n' + str(n) + '.traj')
...
cell_z = delta_z_factor * molecule_length + top_inorganic_z - bottom_inorganic_z
...
print('Enter name of output file [n' + str(n) + prefix + '.traj]')
name = input()

if(len(name) == 0):
    name = 'n'  + str(n) + prefix + '.traj'
    namex = 'n'  + str(n) + prefix + '.xyz'
