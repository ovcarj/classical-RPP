...
final1 = frame[96].position + delta0_rot
...
final7 = frame[70].position + delta0
final7[2] += 54.
...
final3 = frame[83].position - delta0
...
final5 = frame[109].position - delta0_rot
...
atoms.write('1n3_rot_final.traj')
