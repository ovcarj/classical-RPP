...
# This is a code for iodide structures... Should be merged with bromide/mixed.
...
name = cell_type + 'n'  + str(n) + '_' + reof + '_' + super + iodide
...
bottom_inorganic_z = np.amin(ordered[(ordered.symbols == 'Pb') | (ordered.symbols == 'I')].get_positions()[:,2])
top_inorganic_z = np.amax(ordered[(ordered.symbols == 'Pb') | (ordered.symbols == 'I')].get_positions()[:,2])
